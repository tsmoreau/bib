...
const Account = ({ triedToEagerConnect }) => {
    ...
    return (
      <div>
        {hasMetaMaskOrWeb3Available ? (
          ...
          <button
            className="text-th-primary-dark font-futurapt text-xl"
  ...
  return (
    <div className="font-thin flex tracking-wide  font-futurapt text-xl text-white px-5 py-0.5 pt-0.5 border-2 bg-th-accent-light border-th-accent-light hover:bg-th-primary-medium">
