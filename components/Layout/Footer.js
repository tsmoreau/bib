export default function IndexPage() {
  return (
    <div className="pb-44 h-36  w-full justify-center bg-th-background">
      <ul className="text-th-primary-dark pt-6 font-futura text-base flex flex-row justify-center text-center mx-auto">
        <li className=" mx-1.5">
      ...
      <ul className="w-56 text-th-primary-dark mt-3 font-futura text-base flex flex-col mx-auto">
        <li className="flex justify-center">Tetra Entertainment LLC</li>
