export default function IndexPage() {
  return (
    <div className="h-auto pb-0 pt-0 w-full justify-center bg-th-background">
      ...
      <ul className=" lg:hidden w-56 text-th-primary-dark mt-3 font-futurapt font-thin text-base flex flex-col mx-auto">
      ...
      <div className="hidden pt-10  py-4 lg:flex mx-auto justify-center w-full text-base font-futurapt font-thin">
		...
		c-3.77,11.69-11.66,21.62-22.2,27.93c10.01-1.18,19.79-3.86,29-7.95C240.37,35.29,231.83,44.14,221.95,51.29z"
            ...
            <div className="px-8">Terms & Conditions | Privacy Policy</div>
          </div>
        </div>
      </div>
    </div>
